...
from app.models import Base # import for auto alembic
...
config.set_main_option("sqlalchemy.url", f"postgresql+psycopg2://{username}:{password}@{ip_host}:{port}/{database}") # Modify this
...
target_metadata = Base.metadata # modify this for auto alembic
